...
/*
 Functions:
  ...
  CGLM_INLINE void glm_persp_decomp_z_rh_no(mat4 proj,
                                            float * __restrict nearVal,
                                            float * __restrict farVal)
  CGLM_INLINE void glm_persp_decomp_far_rh_no(mat4 proj, float * __restrict farVal)
  CGLM_INLINE void glm_persp_decomp_near_rh_no(mat4 proj, float * __restrict nearVal)
...
CGLM_INLINE
void
glm_persp_decomp_far_rh_no(mat4 proj, float * __restrict farVal) {
...
CGLM_INLINE
void
glm_persp_decomp_near_rh_no(mat4 proj, float * __restrict nearVal) {
...
glm_persp_sizes_rh_no(mat4 proj, float fovy, vec4 dest) {
  ...
  glm_persp_decomp_z_rh_no(proj, &nearVal, &farVal);
