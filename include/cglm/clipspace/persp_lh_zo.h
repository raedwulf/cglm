...
/*
 Functions:
  ...
  CGLM_INLINE void glm_persp_decomp_z_lh_zo(mat4 proj,
                                            float * __restrict nearVal,
                                            float * __restrict farVal)
  CGLM_INLINE void glm_persp_decomp_far_lh_zo(mat4 proj, float * __restrict farVal)
  CGLM_INLINE void glm_persp_decomp_near_lh_zo(mat4 proj, float * __restrict nearVal)
...
CGLM_INLINE
void
glm_persp_decomp_far_lh_zo(mat4 proj, float * __restrict farVal) {
...
CGLM_INLINE
void
glm_persp_decomp_near_lh_zo(mat4 proj, float * __restrict nearVal) {
...
glm_persp_sizes_lh_zo(mat4 proj, float fovy, vec4 dest) {
  ...
  glm_persp_decomp_z_lh_zo(proj, &nearVal, &farVal);
